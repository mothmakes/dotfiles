...

{
  ...
  home-manager.users.mothmitcheson = { pkgs, ...}: {
    ...
    programs.plasma = {
      enable = true;
      shortcuts = {
        "ActivityManager"."switch-to-activity-8698dce5-5913-47e6-89ac-d8bd13c78eab" = [ ];
      ...
      configFile = {
        ...
        "kactivitymanagerdrc"."activities"."8698dce5-5913-47e6-89ac-d8bd13c78eab" = "Default";
        "kactivitymanagerdrc"."main"."currentActivity" = "8698dce5-5913-47e6-89ac-d8bd13c78eab";
        ...
        "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{9cc3864e-f701-416e-a9e0-706d07b2c93f}";
        ...
        "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{f222c2d6-c1c8-4c96-b99c-395e8e025bb0}";
        ...
        "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{91b10cc2-fce3-47d1-a2b5-3ad7f6bfd128}";
        ...
        "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{d942d853-aa5f-485a-bd54-a34ec1ed5db6}";
        ...
        "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{1ff8dda9-15b3-4e56-b10e-26197d72246a}";
        ...
        "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{2f62f68f-53f4-4b44-b074-4424b125f493}";
        ...
        "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{d382c26e-ca6d-4d99-a84c-b57fea290169}";
        ...
        "kwinrc"."Desktops"."Id_1" = "6e12d433-14e0-43a2-8ca2-1fef148f7564";
        "kwinrc"."Desktops"."Number" = 1;
        "kwinrc"."Desktops"."Rows" = 1;
        "kwinrc"."Tiling"."padding" = 4;
        "kwinrc"."Tiling.3b02337a-cced-58e5-8463-2fd437ed46ad"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling.bfbde821-ae3a-5641-8f16-bdd6c6501047"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling.cf9f932f-0af1-54cd-a06b-7bc02df673ce"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling.e4bcc138-08c1-50aa-b7b8-0d2fff210af5"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
